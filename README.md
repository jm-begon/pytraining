...
> Python 3.10 is the basis for the training.

## Installation
1. Run `make setup`
2. activate the virtual environment (`source .venv/bin/activate`)

You might need to supply the path to a Python 3.10 ([troubleshooting](https://stackoverflow.com/questions/69109305/poetry-install-doesnt-create-env-folder-inside-project-folder-with-anaconda-pyt))
